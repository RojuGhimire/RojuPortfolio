        ...
        <div className="flex flex-col lg:flex-row items-center justify-center py-28 h-full bg-black">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-1/2 px-8 lg:px-32">
                ...
                <p className='text-base lg:text-lg text-white mb-6'>
                    Hello! I'm Roju Ghimire, a passionate and dedicated web developer with a strong focus on creating beautiful and efficient websites. I have experience in both web design and development, which allows me to build sites that are not only visually appealing but also highly functional.
                </p>
                <p className='text-base lg:text-lg text-white mb-6'>
                ...
                <p className='text-base lg:text-lg text-white mb-6'>
                    When I'm not coding, I enjoy exploring new technologies, working on personal projects, and continuously improving my skills.
                </p>
                <p className='text-base lg:text-lg text-white mb-6'>
